    ...
    <div className="bg-[#13100d] border border-white/[0.07] rounded-2xl p-6 sm:p-8 mb-5">
      ...
      <div className="relative pl-6">
        <div
          ...
          style={{ background: 'linear-gradient(180deg,#FF6B35,#22d3a0)' }}
        />
        {phases.map((p, i) => (
          <div key={p.key} className="relative mb-4 last:mb-0">
            <div
              ...
              style={{
                ...
                color: i === 0 || i === phases.length - 1 ? '#fff' : '#FF8C5A',
                border: i === 0 || i === phases.length - 1 ? 'none' : '1px solid rgba(255,107,53,0.28)',
              }}
            >
              {i + 1}
            </div>
            ...
            >
              <div className="flex items-center justify-between mb-1 flex-wrap gap-1">
                ...
                <span
                  ...
                  style={{ background: 'rgba(255,107,53,0.12)', color: '#FF8C5A' }}
                >
                  약 {p.days}일
                </span>
              </div>
